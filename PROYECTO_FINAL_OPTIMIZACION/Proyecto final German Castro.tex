...
necesario el surgimiento de tecnologías de simulación que faciliten el proceso de diseño. La investigación efectuada, describe el prooceso de implementación
de un simulador de la potencia recibida en cada uno de los puntos que conforman un escenario de operación descrito por una imagen del plano
de las instalaciones, como resultado de la interacción de un número determinado de puntos de acceso, desplegados en diferentes ubicaciones. El simulador
es empleado para la optimización de la posición del conjunto de puntos de acceso, mediante la implementación de un algoritmo genético.
